...
{
    [Table("ParticularTemp")]
    public partial class ParticularTemp
    {
        public ParticularTemp()
        {
            ParticularTempTrans = new HashSet<ParticularTempTran>();
        }
        ...
        public virtual ICollection<ParticularTempTran> ParticularTempTrans { get; set; }
    }
}
